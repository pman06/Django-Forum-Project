...
class PostUpdateViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        user = User.objects.create_user(username=self.username, password=self.password,email ='jonh@doe.com')
...
class UnauthorizedPostUpdateViewTests(PostUpdateViewTestCase):
    def setUp(self):
        '''
        Create a different user to the one that created the posts
        '''
        super().setUp()
        username = 'jane'
        password ='321'
    ...
    def test_status_code(self):
        '''
        A topic should be edited by the creator.
        Unauthorized users should get 404 page
        '''
...
class PostUpdateViewTests(PostUpdateViewTestCase):
    ...
    def test_form_inputs(self):
        '''
        The view must contain 2 inputs: csrf and textarea
        '''
...
class SuccessfulPostUpdateViewTests(PostUpdateViewTestCase):
    ...
    def test_redirection(self):
        '''
        A valid form submission  redirect the users
        '''
